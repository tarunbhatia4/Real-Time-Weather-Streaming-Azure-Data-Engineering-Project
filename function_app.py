...
def weatherApiFunction(myTimer: func.TimerRequest) -> None:
    ...
    EVENT_HUB_NAMESPACE = "eventhub-weatherstreamingnamespace.servicebus.windows.net" 
    ...
    # Flatten and merge the data for Event Hub ingestion chatgpt 2.0
    def flatten_data(current_weather, forecast_weather, alerts, history_weather_list=None):
        location_data = current_weather.get("location", {})
        current = current_weather.get("current", {})
        condition = current.get("condition", {})
        ...
        flattened_data = {
            ...
            # Dynamic JSON fields (convert to JSON string so KQL dynamic can parse)
    ...
    def fetch_weather_data():
        ...
        forecast_weather = get_forecast_weather(base_url, weatherapikey, location, 10)
...
#         base_url = "http://api.weatherapi.com/v1/"
#         location = "Regina"  # You can replace with any city name based on your preference
